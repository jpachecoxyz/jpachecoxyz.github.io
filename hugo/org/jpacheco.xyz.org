...
#+seq_todo: TODO(t) WAIT(w@/!) | PUBLISHED(d!)

* Configuration files.
** CSS.
...

* Posts:
* PUBLISHED Screen Record                                      :linux:script:
...
:END:
:LOGBOOK:
- State "PUBLISHED"  from              [2024-09-04 Wed 02:43]
:END:
...
* PUBLISHED Efetch.el                                          :emacs:script:
CLOSED: [2024-09-04 Wed 02:43]
:PROPERTIES:
...
* PUBLISHED Void linux bootstrap.                    :linux:tecnology:script:
CLOSED: [2024-09-04 Wed 02:43]
:PROPERTIES:
...
* PUBLISHED Shell-utils                                        :linux:script:
CLOSED: [2024-09-04 Wed 02:43]
:PROPERTIES:
...
* PUBLISHED Share Screen in Hyprland.                         :linux:wayland:
...
:END:
:LOGBOOK:
- State "PUBLISHED"  from              [2024-09-04 Wed 02:44]
...
* PUBLISHED Pymetrics                               :linux:tecnology:wayland:
CLOSED: [2024-09-04 Wed 02:44]
:PROPERTIES:
...
* PUBLISHED Emacs vs Neovim                                 :emacs:tecnology:
CLOSED: [2024-09-04 Wed 02:44]
:PROPERTIES:
...
* PUBLISHED How I made my blog with emacs and hugo :emacs:tecnology:personal:
CLOSED: [2024-09-04 Wed 02:44]
:PROPERTIES:
...
* PUBLISHED Install Telega in NixOS - Emacs.          :emacs:linux:tecnology:
CLOSED: [2024-09-04 Wed 02:44]
:PROPERTIES:
...
* PUBLISHED Search tool in your HUGO website.                :blog:tecnology:
CLOSED: [2024-09-04 Wed 02:44]
:PROPERTIES:
...
* PUBLISHED Basics of HUGO                          :blog:personal:tecnology:
...
:END:
:LOGBOOK:
- State "PUBLISHED"  from "TODO"       [2024-09-04 Wed 03:32]
- State "PUBLISHED"  from              [2024-09-04 Wed 02:44]
