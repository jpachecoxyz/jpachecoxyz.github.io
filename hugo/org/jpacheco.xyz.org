...
*** FIXME yasnipet insert auto tags.
#+begin_src elisp
...
*** Working with Themes
To install a theme is basically download it from =GitHub=, you can find one of your like [[https://themes.gohugo.io/themes][here]].
...
2. [[https://gohugo.io/documentation/][Hudo documentation.]]
