...
:PROPERTIES:
:EXPORT_FILE_NAME: content/wiki/wiki.md
:EXPORT_DESCRIPTION: My personal wiki for some topics.
:DATE: [2024-09-03 Tue]
:EXPORT_HUGO_SECTION: 
:END:
:LOGBOOK:
- State "DONE"       from "TODO"       [2024-09-03 Tue 15:40]
  This wiki is marked as done but still in constant modification.
:END:
