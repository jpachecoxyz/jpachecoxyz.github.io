...
The most common answer for that is very universal: `It depends`, if you want to learn more about lisp definetly this is your distribution, for me this is the fastest init that I ever had, and the best of everything is that I can install `nix` the package manager and use ti whitin guix, is fantastic.
